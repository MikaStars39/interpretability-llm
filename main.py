...
model = LlamaForCausalLM.from_pretrained("/home/qingyu_yin/model/llama-2-7b-hf").to("cuda").to(torch.half)
...
inputs = tokenizer(text, return_tensors="pt").to("cuda").to(torch.half)
