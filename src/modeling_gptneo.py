...
class GPTNeoModel(GPTNeoPreTrainedModel):
    def __init__(self, config):
        ...
        # self.w_merge = nn.Linear(self.embed_dim, self.embed_dim)
    ...
    def forward(
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            # if i == 0:
            #     saved_hidden_state = hidden_states
            
            # if i == 20:
            #     hidden_states = hidden_states + self.w_merge(saved_hidden_state)
